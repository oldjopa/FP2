...
let main (argv: string array) =
    ...
    let tree = tree |> insert 2 |> insert 3 |> insert 3 |> insert 7 |> insert 4 |> insert 8
    printTree tree ""
    ...
    let mergedTree = mergeTrees tree tree2
    printTree mergedTree ""



    let tree3 = Empty |> insert 5 |> insert 3 |> insert 7 |> insert 3 |> insert 6 |> insert 8
    printTree tree3 "-"
